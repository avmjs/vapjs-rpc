...
All information regarding contributing to and progressing `vapjs-rpc` module can be found in this document.
...
```
git clone http://github.com/vapjs/vapjs-rpc
npm install
```
...
Please help better the ecosystem by submitting issues and pull requests. We need all the help we can get to build the absolute best linting standards and utilities. We follow the AirBNB linting standard. Please read more about contributing to `vapjs-rpc` in the `.github/CONTRIBUTING.md`.
